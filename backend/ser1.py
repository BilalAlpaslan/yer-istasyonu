...
def convert_to_bytes(
    ...
    my_bytes[4] = int(12).to_bytes(1, 'big')[0]
...
def main():
    ...
    sayac = 0
    data = '34,0,0,0,0,0,35'
    data2 = '36,0,0,0,0,0,0,0,37'
    ...
    while True:
        ...
        if data.split(',')[0] == '34' and data.split(',')[-1] == '35':
            veriii = data.split(',')
        if data2.split(',')[0] == '36' and data2.split(',')[-1] == '37':
            veriii2 = data2.split(',')
        veriii = [i if i != '' else 0. for i in veriii]
        veriii2 = [i if i != '' else 0. for i in veriii2]

        print(data.split(',') + data2.split(','))
        save_to_file(data.split(',') + data2.split(','))
        ...
        if veriii[5] in ['0', '1']:
            ...
            durum = 2
        elif veriii[5] in ['3', '4']:
            durum = 4

        if veriii[0] == '34' and veriii[-1] == '35':
            durum = 0
